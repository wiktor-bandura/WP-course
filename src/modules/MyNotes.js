...
class MyNotes {
    ...
    async deleteNote(e) {
        ...
        try {
            const response = await axios.delete(themeData.root_url + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"))
    ...
    async updateNote(e) {
        ...
        try {
            const response = await axios.post(themeData.root_url + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"), ourUpdatedPost)
            this.makeNoteReadOnly(thisNote)
        } catch (e) {
            console.log("Sorry")
        }
    ...
    async createNote() {
        ...
        try {
            const response = await axios.post(themeData.root_url + "/wp-json/wp/v2/note/", ourNewPost)
